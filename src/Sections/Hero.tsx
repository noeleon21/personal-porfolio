export default function Hero() {
  return (
    <section className="grid md:grid-cols-2 gap-8 items-center py-12">
      <div>
        <p className="text-sky-500 font-medium"> Hi, I'm</p>
        <h1 className="text-4xl sm:text-5xl font-extrabold mt-2">Noel Gens</h1>
        <p className="mt-4 text-lg text-white">Cybersecurity graduate & Cloud Engineer. I build secure, scalable systems and developer-friendly tooling.</p>
